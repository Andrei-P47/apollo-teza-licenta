...
function Nav() {
  ...
  return (
    <nav className="px-[24px] md:px-[40px] lg:px-[60px] pt-[20px] flex flex-row justify-between items-center fixed top-0 right-0 left-0 bg-[#110929] transition-colors delay-100 z-50">
      <Link href="/">
        <Image
          className="py-[19.5px] hidden md:block"
          src="/ApolloNFT.svg"
          alt="logo"
          width={171}
          height={40}
    ...
    // <nav className="navbar navbar-expand navbar-dark bg-dark z-50 fixed top-0 w-full">
